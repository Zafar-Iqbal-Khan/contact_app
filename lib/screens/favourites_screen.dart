      ...
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {
            showSearch<Contact?>(
              context: context,
              delegate: ContactSearchDelegate(favorites),
            );
          },
        ),
        title: Text(
                  ...
                  itemBuilder: (context, i) => GestureDetector(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              ContactDetailScreen(contact: favorites[i]),
                        ),
                      );
                    },
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => ContactDetailScreen(contact: results[index]),
              ),
            );
          },
          child: ContactTile(contact: results[index]),
        );
      },
    );
  }
